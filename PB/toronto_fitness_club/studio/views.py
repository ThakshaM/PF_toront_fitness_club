    ...
    def post(self, request, *args, **kwargs):
        ...
        if auth_token:
            ...
            return HttpResponseRedirect(
                redirect_to='http://127.0.0.1:8000/studio/search_studio/')
...
class GeoProxStudioByPostal(CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if auth_token:
            ...
            pat = re.compile(
                r"^[ABCEGHJKLMNPRSTVXYabceghjklmnprstvxy]{1}[0-9]{1}[ABCEGHJKLMNPRSTVXYabceghjklmnprstvxy]{1}[ ]?[0-9]{1}[ABCEGHJKLMNPRSTVXYabceghjklmnprstvxy]{1}[0-9]{1}$")
            if not re.fullmatch(pat, postal_code):
                return Response(
...
class SearchStudio(ListCreateAPIView):
    ...
    # search also needs to include 'nitish' stuff, class names, and coaches
    ...
    def get_serializer_class(self, *args, **kwargs):
        if self.request.method == 'POST':
            return StudioClickOnSerializer
